      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
		  ...
		  <div class="row">
			...
			$stid = oci_parse($koneksi, "SELECT * FROM kelas WHERE ID_KELAS ='$id_kelas'");
			oci_execute($stid);
			...
			?>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='post' action='aksi_kelas.php?act=update'>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ruang_kelas" value="<?php echo $d["RUANG_KELAS"]; ?>">

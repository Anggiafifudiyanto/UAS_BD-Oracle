...
<head>
  ...
  <!-- CSS Files -->
  <link href="login/css/material-kit.css?v=2.0.7" rel="stylesheet" />
...
<body class="landing-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('login/img/sekolah.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <a href="login.php" class="btn btn-success btn-raised btn-lg">
            <i class="material-icons"></i> Masuk
          </a>
        </div>
      </div>
    </div>
  ...
  <script src="login/js/core/bootstrap-material-design.min.js" type="text/javascript"></script>
  <script src="login/js/plugins/moment.min.js"></script>
  <!--	Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker -->
  <script src="login/js/plugins/bootstrap-datetimepicker.js" type="text/javascript"></script>
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <script src="login/js/plugins/nouislider.min.js" type="text/javascript"></script>
  <!--  Google Maps Plugin    -->
  <!-- Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
  <script src="login/js/material-kit.js?v=2.0.7" type="text/javascript"></script>
</body>

            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Form Data Admin Tata Usaha</h6>
                </div>
                <div class="card-body">
                  <form method='post' action='aksi_admin.php?act=input'>
                    <div class="form-group">
                      <label for="ID_ADMIN">ID Admin</label>
                      <input type="text" class="form-control" name="id_admin" placeholder="masukkan ID Admin">
                   <br>

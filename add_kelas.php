		  ...
		  <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='post' action='aksi_kelas.php?act=input'>
                    <div class="form-group">
                      <label for="ID_KELAS">ID Kelas</label>
                      <input type="text" class="form-control" name="id_kelas" placeholder="masukkan ID Kelas">
                   <br>
                    ...
                    <label for="RUANG_KELAS">Ruang Kelas</label>
                      <input type="text" class="form-control" name="ruang_kelas" placeholder="masukkan alamat">
                      <br>
                    </div>                    
